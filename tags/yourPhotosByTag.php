...
<body>
  <center> <h2>View Your Photos: </h2></center>
  
  <form action="yourPhotosByTag.php" method="post" enctype ="multipart/form-data">
     ...
     <br>
       <script type="text/javascript"> 
            function browse() {
              ...
              window.location.assign("http://localhost:8888/picShare/tags/mostPopularTags.php")
            }
            
        </script>
     <input type ="button" value="View most popular tags" onclick="browse()">
